...
int main(){	
	...
	}while(1); //This line of code is not completed. You need to set the condition to do loop if user's input is not 1 or 2. 
	if(playerAction == 1){
		cout<<"Player draws the 3rd card!!!";
		playerCards[2]=drawCard();
		cout << "\nYour 3rd card: " << cardNames[playerCards[2]];
		playerScore = calScore(playerCards[0],playerCards[1],playerCards[2]);
		cout << "\nYour new score: " << playerScore << "\n";
	}
	cout << "------------ Turn end -------------------\n\n";
